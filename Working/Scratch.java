...
public class Scratch {
    ...
    public static final boolean TRIG = true;
    ...
    public static void main(String[] args) {
        ...
        if (TRIG) {
            ...
            System.out.println("Math.atan(3/5) = " + Math.atan(Y/X));
            System.out.println("Math.atan(-3/5) = " + Math.atan(-Y/X));
            System.out.println("Math.atan(3/-5) = " + Math.atan(Y/-X));
            System.out.println("Math.atan(-3/-5) = " + Math.atan(-Y/-X));

            System.out.println("Math.atan(3/-5) + PI = " + Math.atan(Y/-X)+Math.PI);
            System.out.println("Math.atan(-3/-5) + PI = " + Math.atan(-Y/-X)+Math.PI);


            System.out.println("Math.atan2(3/5) = " + Math.atan2(3 , 5));
            System.out.println("Math.atan2(-3/5) = " + Math.atan2(-3 , 5));
            System.out.println("Math.atan2(3/-5) = " + Math.atan2(3 , -5));
            System.out.println("Math.atan2(-3/-5) = " + Math.atan2(-3 , -5));
